...
const GuessRow = ({
  ...
  return (
    <View style={styles.guessRow}>
      <WordBox index={0} guess={guess} word={word} guessed={guessed} />
      <WordBox index={1} guess={guess} word={word} guessed={guessed} />
      <WordBox index={2} guess={guess} word={word} guessed={guessed} />
      <WordBox index={3} guess={guess} word={word} guessed={guessed} />
      <WordBox index={4} guess={guess} word={word} guessed={guessed} />
    </View>
  )
}
